package top.natsuki.weblog.admin.config;
...
public class Knife4jAdminConfig {
    ...
    public Docket createApiDoc() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("top.natsuki.weblog.admin.controller"))
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("natsuki", "https://natsukiz.top", "natsukiz@foxmail.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}